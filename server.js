...
// Generates config.js from environment variables, then serves the static site
...
function generateConfig() {
  ...
  if (!config.SUPABASE_URL || !config.SUPABASE_ANON_KEY) {
    console.warn('⚠  SUPABASE_URL or SUPABASE_ANON_KEY not set — Supabase features will not work.');
    console.warn('   Add these secrets in the Replit Secrets panel.');
  }

  const output = `// Auto-generated by server.js at startup — do not edit
const CONFIG = {
...
// Fallback for clean URLs — try .html extension
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`✅ Choice Properties running on port ${PORT}`);
});
